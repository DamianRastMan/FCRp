...
$(document).ready(function(){
	...
	if($.inArray(getCookie('fcmenu-employeeLogin'),users) >(-1)){
		...
		$('body').append('<div id="#fcrp_sgn" style="position:fixed;background-color:tomato;color:white;width:10px;padding:5px;border-radius:10px;bottom:10px;right:10px;" />');
		$('#fcrp_sgn').html('Uzywasz FCReaseach+ by jachyd');
	}
	else {
